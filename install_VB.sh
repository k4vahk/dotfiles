...
echo -e "${BLUE}[*] INICIANDO POST-INSTALACIÓN (VirtualBox Edition)${NC}"
...
# --- 1. DEPENDENCIAS BASE (Omitimos lo que archinstall ya pone) ---
...
echo -e "${GREEN}[+] Instalando paquetes (Versión VirtualBox)...${NC}"
...
PACMAN_PKGS=(
    ...
    mesa # Drivers genéricos gráficos
...
# --- ESPECÍFICO VIRTUALBOX ---
echo -e "${GREEN}[+] Activando servicios de VirtualBox...${NC}"
...
echo -e "${GREEN}[✓] INSTALACIÓN VIRTUALBOX COMPLETADA. Reinicia el sistema.${NC}"
